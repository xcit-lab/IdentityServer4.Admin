...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Services
{
    public class PersistedGrantServiceTests
    {
        ...
        private IPersistedGrantAspNetIdentityRepository GetPersistedGrantRepository(AdminDbContext context)
        {
            var persistedGrantRepository = new PersistedGrantAspNetIdentityRepository<AdminDbContext, AdminDbContext, UserIdentity, UserIdentityRole, int, UserIdentityUserClaim, UserIdentityUserRole, UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken>(context, context);

            return persistedGrantRepository;
        }

        private IPersistedGrantAspNetIdentityService GetPersistedGrantService(IPersistedGrantAspNetIdentityRepository repository, IPersistedGrantAspNetIdentityServiceResources persistedGrantServiceResources)
        {
            var persistedGrantService = new PersistedGrantAspNetIdentityService<AdminDbContext, AdminDbContext, UserIdentity, UserIdentityRole, int, UserIdentityUserClaim,
